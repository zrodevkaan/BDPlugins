                ...
                {users.map(user => {
                    ...
                    return (
                        ...
                        >
                            <img
                                src={
                                    directUser?.joinedAt && directUser?.avatar
                                        ? `https://cdn.discordapp.com/guilds/${guild.id}/users/${directUser.userId}/avatars/${directUser.avatar}.png`
                                        : directUser?.avatar
                                            ? `https://cdn.discordapp.com/avatars/${directUser?.id}/${directUser?.avatar}.png`
                                            : `https://cdn.discordapp.com/embed/avatars/${getAvatar(directUser.id)}.png`
                                }
                                style={{
                                    width: '20px',
                                    height: '20px',
                            ...
                            {userState.selfVideo && <VideoIcon />}
                            {userState.selfStream && <LiveStream />}
                        </div>
                    );
                })}
            </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <h2 style={{
                                        ...
                                        {guild.name}
                                        {dropped[guild.id] ? (
                                            <EyeClose width="24px" height="24px" />
                                        ) : (
