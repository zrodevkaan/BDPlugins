...
const BlockedSVG = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" fill="var(--interactive-icon-default)" width="20px" height="20px" viewBox="0 0 32 32"
                version="1.1">
        <path color={'var(--interactive-icon-default)'}
