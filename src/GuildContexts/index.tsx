...
const { Patcher, React, Webpack, ContextMenu } = new BdApi('GuildContexts');

const UserProfileModal = Webpack.getByKeys('openUserProfileModal');
const UserModule = Webpack.getByKeys('getMutualGuilds')
const GuildStore = Webpack.getStore('GuildStore');

const GuildIcon = ({ size = 16, color = 'currentColor', ...props }) => (
    <svg
...
export default class GuildContexts {
    constructor() {
