...
// src/DisplayAlbums/index.tsx
var { Patcher, Webpack: Webpack3, Data, React: React2, Utils } = new BdApi("DisplayAlbums");
...
var AudioModule = Webpack3.getBySource("clip_participants", "playbackCacheKey");
...
var DisplayAlbums = class {
  start() {
    const module2 = getKey(AudioModule, Webpack3.Filters.combine(Webpack3.Filters.byStrings("item.originalItem;return(0,"), Webpack3.Filters.byStrings("fileSize:")));
