  ...
  start() {
    ...
    for (const obj of colorRegexArray) {
      ...
      markdown.defaultRules[name] = {
        ...
        react: (node) => /* @__PURE__ */ BdApi.React.createElement(Components.ErrorBoundary, { fallback: /* @__PURE__ */ BdApi.React.createElement("span", null, node.color) }, /* @__PURE__ */ BdApi.React.createElement(ChatColorComp, { color: node.color.replace(" ", "") }))
      };
      index++;
    }
