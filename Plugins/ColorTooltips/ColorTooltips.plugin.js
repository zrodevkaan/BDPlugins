...
function mixHexColors(hexA, hexB, amount) {
  ...
  const w = amount / 100;
  const blend = (a, b) => Math.round(a + (b - a) * w);
  return "#" + [blend(r1, r2), blend(g1, g2), blend(b1, b2)].map((c) => c.toString(16).padStart(2, "0")).join("");
}
function getColorInfo(rawColor) {
...
function getAdjustments(rawColor) {
  const base = tinycolor(rawColor);
  if (!base.isValid()) return [];
  const make = (fn) => fn(tinycolor(rawColor)).toHexString();
...
function ChatColorPopoutContent({ targetRef, format: initialFormat = "hex" }) {
  ...
  const [copiedAdjustment, setCopiedAdjustment] = React.useState(null);
  ...
  const handleAdjustmentCopy = async (hex, label) => {
  ...
  return /* @__PURE__ */ BdApi.React.createElement("div", { style: {
    ...
    borderRadius: "8px",
    padding: "6px"
  } }, /* @__PURE__ */ BdApi.React.createElement("div", { style: { display: "flex", flex: 1, flexWrap: "wrap", gap: "6px" } }, formats.map(({ label, value }) => {
    ...
    return /* @__PURE__ */ BdApi.React.createElement(
      Components.Button,
      {
        ...
        style: {
          ...
          borderRadius: "6px",
          cursor: "pointer",
          backgroundColor: active ? "var(--interactive-background-selected)" : "var(--interactive-background-selected, rgba(255,255,255,0.4))",
    ...
    flexDirection: "column",
    gap: "8px"
  } }, /* @__PURE__ */ BdApi.React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "12px" } }, /* @__PURE__ */ BdApi.React.createElement("div", { style: {
  ...
  } }), /* @__PURE__ */ BdApi.React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "4px" } }, /* @__PURE__ */ BdApi.React.createElement(
    "span",
    {
      onClick: handleCopy,
      style: {
  ...
  ), info && /* @__PURE__ */ BdApi.React.createElement("div", { style: {
    display: "flex",
    flexWrap: "wrap",
    gap: "10px",
    fontSize: "12px",
    color: "var(--text-muted, #949ba4)"
  } }, /* @__PURE__ */ BdApi.React.createElement("span", null, info.isLight ? "Light" : "Dark"), /* @__PURE__ */ BdApi.React.createElement("span", null, "Brightness ", info.brightness, "/255"), /* @__PURE__ */ BdApi.React.createElement("span", null, "Luminance ", info.luminance))))), adjustments.length > 0 && /* @__PURE__ */ BdApi.React.createElement("div", { style: {
    backgroundColor: "var(--background-gradient-highest,var(--chat-background-default))",
    borderRadius: "8px",
    padding: "10px",
    marginTop: "8px",
  ...
  } }, "Adjustments"), /* @__PURE__ */ BdApi.React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: "6px" } }, adjustments.map(({ label, hex }) => /* @__PURE__ */ BdApi.React.createElement(
    Components.Tooltip,
    {
      key: label,
      text: copiedAdjustment === label ? "Copied!" : `${label} \xB7 ${hex}`
    },
    (x) => /* @__PURE__ */ BdApi.React.createElement(
      ...
      /* @__PURE__ */ BdApi.React.createElement("span", { style: { fontSize: "12px", color: "#fff" } }, label)
    )
  )))));
}
  ...
  start() {
    ...
    for (const obj of colorRegexArray) {
      ...
      markdown.defaultRules[name] = {
        ...
        parse: (capture) => ({ color: capture[0].toLowerCase() || capture[1].toLowerCase() || "red" }),
        react: (node) => /* @__PURE__ */ BdApi.React.createElement(
          Components.ErrorBoundary,
          {
            fallback: /* @__PURE__ */ BdApi.React.createElement("span", null, node.color)
          },
